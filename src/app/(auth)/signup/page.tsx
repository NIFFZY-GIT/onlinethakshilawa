...
export const metadata: Metadata = {
  title: 'Sign Up',
  description: 'Create an account to join our LMS.',
};
      ...
      <div className="hidden bg-gray-100 lg:block">
        <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-blue-600 to-indigo-800 p-12">
            <div className="text-white text-center">
                <h1 className="text-4xl font-bold tracking-tight">Join Our Learning Community</h1>
                <p className="mt-4 text-lg text-indigo-100">
                    Get started in seconds. Create your account to access exclusive courses and track your progress.
                </p>
            </div>
        </div>
      </div>
